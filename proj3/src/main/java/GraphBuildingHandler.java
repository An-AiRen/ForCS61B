...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<GraphDB.Edge> possibleE;
    /**
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeState = "way";
            firstNode = true;
            possibleE = new ArrayList<>();
            wayValid = false;
            wayName = ""; //almost forget it!
        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
            if (firstNode) {
                lastNode = Long.parseLong(attributes.getValue("ref"));
                firstNode = false;
            } else {
                long cur = Long.parseLong(attributes.getValue("ref"));
                GraphDB.Edge e = new GraphDB.Edge(lastNode, cur, g.distance(lastNode, cur));
                possibleE.add(e);
                lastNode = cur;
            }
            ...
            if (k.equals("maxspeed")) {
                ...
                if (ALLOWED_HIGHWAY_TYPES.contains(value)) { //waste my time!
                    wayValid = true;
                }
            ...
            g.addName(attributes.getValue("v"), lastNode);
        }
    }
